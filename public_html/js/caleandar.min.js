...
function createCalendar(e, t, a) {
    function n()
    {
        ...
        for (var l = 0; l < s.length - 3; l++) {
            ...
            if (0 > d ? d += 12 : d > 11 && (d -= 12), 0 == l)
                i.className += " cld-rwd cld-nav", i.addEventListener("click", function () {
    ...
    var s = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], r = document.createElement("div");
...
var Calendar = function (e, t, a) {
    this.Options = {Color: "", LinkColor: "", NavShow: !0, NavVertical: !1, NavLocation: "", DateTimeShow: !0, DateTimeFormat: "mmm, yyyy", DatetimeLocation: "", EventClick: "", EventTargetWholeDay: !1, DisabledDays: [], ModelChange: e};
    for (var n in t)
